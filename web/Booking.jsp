<%-- 
    Document   : Booking
    Created on : Jun 18, 2024, 1:13:46 PM
    Author     : Sơnnnn
--%>
            ...
            <div class="header-box mb-4">
                <form class="form-inline row align-items-end">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control w-100" id="destination" placeholder="Destination" value="FLC City Hotel Beach Quy Nhon">
                    </div>
                    <div class="form-group col-md-3">
                ...
                <div class="col-md-9">
                    ...
                    <div class="room-card">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn" style="background-color: #C59B24; color: white">Room details</button>
                        </div>
                    </div>
