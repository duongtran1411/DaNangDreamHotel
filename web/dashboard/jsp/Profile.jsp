        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item" style="font-size: 1.1rem"><strong>Name: </strong> Pham Quang Minh</li>
                    <li class="list-group-item" style="font-size: 1.1rem"><strong>Phone: </strong> 0981302003</li>
                    <li class="list-group-item" style="font-size: 1.1rem"><strong>Email: </strong>: minh92419@gmail.com</li>
                </ul>
