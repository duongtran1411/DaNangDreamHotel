...
<aside class="left-sidebar" style="background-color: #213e66;height: 100%" >
    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <div>
                <div>
                    <a  class="sidebar-link" href="customerController" aria-expanded="false">
                        <img src="img/header_homepage.jpg" alt="alt" width="200px" height="50px"/>
                    </a>
                </div>
            </div>
            <c:if test="${sessionScope.acc.role_Id == 3 ||sessionScope.acc.role_Id == 1 }">
            ...
            <button style="margin-top: 20px" class="btn hide-menu btn-manage btnshow" id="show"><label class="white btn-manage" >MANAGER<i class="fa-solid fa-angle-down btn-manage" style="padding-left: 20px"></i></label></button>
            ...
            <ul id="sidebarnav" class="list" style="display: block">
                ...
                <c:if test="${sessionScope.acc.role_Id == 2}">
                    ...
                    <li  class="sidebar-item">
                        <a  class="sidebar-link" href="useSuppliesURL" aria-expanded="false">
                            <span>
                                <i class="fa-solid fa-credit-card white"></i>
                            </span>
                            <span class="hide-menu white">Check Out</span>
                        </a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.acc.role_Id == 3}">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="${pageContext.request.contextPath}/manageFeedBackController" aria-expanded="false">
                            <span>
                                <i class="fa-solid fa-comments white"></i>
                            </span>
                            <span class="hide-menu white">Manage FeedBack</span>
                        </a>
                    </li>
                </c:if>
